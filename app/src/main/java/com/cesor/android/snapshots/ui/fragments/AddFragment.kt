...
import com.cesor.android.snapshots.databinding.FragmentAddBinding
import com.cesor.android.snapshots.entities.Snapshot
...
class   AddFragment : Fragment() {
    ...
    private fun postSnapshot() {
        if (mPhotoSelectedUri != null){
            ...
            val myStorageRef = mSnapshotsStorageRef.child(SnapshotsApplication.currentUser.uid).child(key)
