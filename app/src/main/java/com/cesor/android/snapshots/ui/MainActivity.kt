package com.cesor.android.snapshots.ui
...
import com.cesor.android.snapshots.*
import com.cesor.android.snapshots.databinding.ActivityMainBinding
import com.cesor.android.snapshots.ui.fragments.AddFragment
import com.cesor.android.snapshots.ui.fragments.HomeFragment
import com.cesor.android.snapshots.ui.fragments.ProfileFragment
import com.cesor.android.snapshots.utils.FragmentAux
import com.cesor.android.snapshots.utils.MainAux
...
class MainActivity : AppCompatActivity(), MainAux{
    ...
    private fun setupBottomNav(fragmentManager : FragmentManager) {
        ...
        mBinding.bottomNavMenu.setOnItemReselectedListener {
            when(it.itemId){
    ...
    override fun showMessage(resId: Int, duration: Int) {
        Snackbar.make(mBinding.root, resId, duration)
            .setAnchorView(mBinding.bottomNavMenu)
            .show()
    }
}